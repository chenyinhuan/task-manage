<template>
	<div id="assigment">
		<el-dialog title="" :visible.sync="visible" width="738px">
...
<!--			</span>-->
      ...
      <div class="tranferbox">
        <div class="conbox" style="background: #F7F7F7">
          <div class="titbox">
            <el-input size="mini" placeholder="输入人员名称" suffix-icon="el-icon-search" v-model="filterText"></el-input>
          </div>
          <div class="wordbox">
            <el-tree
              @check="getData"
...
<!--              </li>-->
<!--            </ul>-->
            <el-tag @close="removeData(item)" v-for="(item,index) in keyarr" :key="index" closable type="info">
              {{item.label}}
            </el-tag>
          </div>
        </div>
    ...
    .tranferbox{
      ...
      .conbox{
        ...
        .wordbox{
          ...
          ul{
            li{
              .inli{ display: flex; align-items: baseline; }
              span{ font-size:12px; display:block; width:70px; padding-left:10px }
              .el-icon-s-custom{ color:#93a9d3 }
              .el-icon-close{ color:#808080; cursor: pointer; }
            }
          }
        }
      }
